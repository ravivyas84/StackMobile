package com.ravivyas.mStackEx.HTTP.processor;
...
public abstract class AsyncHTTPProcessor extends AsyncTask<Void, Integer, byte[]> {
    ...
    public AsyncHTTPProcessor( AsyncHTTPRequestObject request ) {
        contentLength = -1;
    ...
    protected final byte[] doInBackground( Void... params ) {
        ...
        HttpConnectionParams.setSoTimeout(httpParameters, request.getSoTimeout());
